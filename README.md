...
Balanced Score: A custom mathematical metric defined as log(CF + 1) * DF^2, ideal for finding highly recurrent and evenly distributed keywords.
...
git clone [https://github.com/your-username/text-metrics-analyzer.git](https://github.com/your-username/text-metrics-analyzer.git)
